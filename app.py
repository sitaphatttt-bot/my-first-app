...
st.write("นี่คือเว็บแอปพลิเคชันแรกในชีวิตของผม/ดิฉัน เขียนด้วยภาษา Pythonค่ะ")

st.divider() # เส้นคั่นแบ่งสัดส่วนให้สวยงาม

# ส่วนข้อมูลส่วนตัว (Profile Info)
st.header("👤 ข้อมูลส่วนตัว")
st.write("**ชื่อ-นามสกุล:** นางสาว ศิตาภัทร์ ธัญชลีนาวงศ์")
st.write("**ชั้น ม.4/2** เลขที่ 29")
